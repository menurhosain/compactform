...
class Text_Field extends Input_Field {
	...
	protected function get_tag(): string { return 'text'; }
	public function get_type(): string { return 'text'; }
	public function get_title(): string { return __( 'Text', 'compactform' ); }
	public function get_icon(): string { return 'ri-t-box-line'; }
