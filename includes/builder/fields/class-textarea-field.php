...
class Textarea_Field extends Input_Field {
	...
	protected function get_tag(): string { return 'textarea'; }
	public function get_type(): string { return 'textarea'; }
	public function get_title(): string { return __( 'Textarea', 'compactform' ); }
	public function get_icon(): string { return 'ri-quote-text'; }
	public function get_preview(): string { return 'textarea'; }
