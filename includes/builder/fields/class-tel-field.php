...
class Tel_Field extends Input_Field {
	...
	protected function get_tag(): string { return 'tel'; }
	public function get_type(): string { return 'tel'; }
	public function get_title(): string { return __( 'Phone', 'compactform' ); }
	public function get_icon(): string { return 'ri-phone-line'; }
