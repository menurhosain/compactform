...
class Date_Field extends Input_Field {
	...
	protected function get_tag(): string { return 'date'; }
	public function get_type(): string { return 'date'; }
	public function get_title(): string { return __( 'Date', 'compactform' ); }
	public function get_icon(): string { return 'ri-calendar-line'; }
