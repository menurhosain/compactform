...
class Email_Field extends Input_Field {
	...
	protected function get_tag(): string { return 'email'; }
	public function get_type(): string { return 'email'; }
	public function get_title(): string { return __( 'Email', 'compactform' ); }
	public function get_icon(): string { return 'ri-mail-line'; }
