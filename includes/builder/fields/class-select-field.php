...
use CompactForm\Builder\Abstracts\Traits\Multi_Select_Style_Control;
...
class Select_Field extends Choice_Field {
	...
	use Multi_Select_Style_Control;
	use Description_Style_Control;
	use Advanced_Control;
	use Field_Icon_Control;
	use Conditional_Control;

	protected function get_tag(): string { return 'select'; }
	public function get_type(): string { return 'select'; }
	public function get_title(): string { return __( 'Dropdown', 'compactform' ); }
	public function get_icon(): string { return 'ri-arrow-drop-down-fill'; }
	...
	protected function register_controls(): void {
		...
		$this->register_choices_control( true );
		...
		do_action( 'fcf7_select_field_pricing_controls', $this, 'choices' );
		$this->end_section();
		...
		do_action( 'fcf7_select_field_pricing_controls', $this, 'pricing' );
		$this->end_section();

		$this->register_label_style_controls();
		$this->register_field_style_controls( false, true );
		$this->register_multi_select_style_controls();
