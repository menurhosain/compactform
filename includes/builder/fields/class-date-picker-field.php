...
class Date_Picker_Field extends Extension_Field
{
	use Label_Control;
	use Name_Control;
	...
	private $option_keys = ['mode', 'date_format', 'min_date', 'max_date', 'default_date'];

	public function get_type(): string
	{
		return 'fcf7_date_picker';
	}
	public function get_title(): string
	{
		return __('Date Picker', 'compactform');
	}
	...
	protected function register_controls(): void
	{
		...
		$this->start_section( 'date', [
			'label' => __('Date Options', 'compactform'),
			'tab'   => Controls_Manager::TAB_SETTINGS,
		] );
	...
	public function render_front($tag, $form_id = 0)
	{
		...
		return apply_filters('fcf7_date_picker_output', $output, $tag);
	}
