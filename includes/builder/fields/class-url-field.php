...
class Url_Field extends Input_Field {
	...
	protected function get_tag(): string { return 'url'; }
	public function get_type(): string { return 'url'; }
	public function get_title(): string { return __( 'URL', 'compactform' ); }
	public function get_icon(): string { return 'ri-links-line'; }
